...
/* The SLModule classes are ServiceLocator aware, and they are also intimate with the concrete classes
 * they bind to and so know what dependancies are required to create instances */
